    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[(1, '드라마'), (2, '판타지'), (3, '서부'), (4, '공포'), (5, '로맨스'), (6, '모험'), (7, '스릴러'), (8, '느와르'), (9, '컬트'), (10, '다큐멘터리'), (11, '코미디'), (12, '가족'), (13, '미스터리'), (14, '전쟁'), (15, '애니메이션'), (16, '범죄'), (17, '뮤지컬'), (18, 'SF'), (19, '액션'), (20, '무협'), (21, '에로'), (22, '서스펜스'), (23, '서사'), (24, '블랙코미디'), (25, '실험'), (26, '영화카툰'), (27, '영화음악'), (28, '영화패러디포스터'), (29, '기타')], max_length=20, unique=True, verbose_name='장르')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticketing_rate', models.CharField(blank=True, max_length=10, verbose_name='예매율')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_thumbnail', models.URLField(blank=True, verbose_name='커버 이미지 URL')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='수정일시')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='생성일시')),
                ('movie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='movie.Movie', verbose_name='영화')),
            ],
