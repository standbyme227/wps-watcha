# Generated by Django 2.0.3 on 2018-04-10 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_avg', models.DecimalField(decimal_places=1, default=0.0, max_digits=2, validators=[django.core.validators.MaxValueValidator(5)], verbose_name='평점평균')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('1', 'director'), ('2', 'scenario-writer'), ('3', 'etc-staff'), ('4', 'main-actor'), ('5', 'supporting-actor'), ('6', 'extra')], max_length=5, verbose_name='구성원 분류')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('still_img', models.ImageField(upload_to='still_cut', verbose_name='스틸 이미지')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='수정일시')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='생성일시')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='movie',
            name='still_cut',
            field=models.ManyToManyField(blank=True, to='movie.StillCut'),
        ),
        migrations.AddField(
            model_name='movie',
            name='tag',
        ...
        migrations.AddField(
            model_name='movie',
            name='trailer',
            field=models.ManyToManyField(blank=True, to='movie.TrailerYouTube'),
        ),
        migrations.AddField(
            model_name='movie',
            name='user',
